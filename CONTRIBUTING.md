...
* The Description should be written in plain English and avoid vague phrases like "A tool for..." or "An API that..." — just describe what it does directly (e.g. "NASA data, including imagery" not "An API that provides NASA data").
